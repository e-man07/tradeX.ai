...
export default function Chat() {
  const { processTransfer, processSwap, processPumpFunToken } =
    useSolanaAgent();
        ...
        <SidebarInset>
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  <BreadcrumbItem className="hidden md:block">
                    <BreadcrumbLink href="#">Have fun with kira</BreadcrumbLink>
                  </BreadcrumbItem>
          ...
          <section className="flex flex-col items-center justify-center h-[80vh]">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 px-4 ">
              <div className="flex gap-1 items-center border px-3 rounded-full text-xs">
                Make an onboarding form <ArrowUpRight className="w-3" />
              </div>
              <div className="flex gap-1 items-center border px-3 rounded-full text-xs">
                Build now solana <ArrowUpRight className="w-3" />
              </div>
            </div>
            <div className="flex items-center justify-center gap-2 mt-2 w-[400px]">
              <div className="flex gap-1 items-center border px-3 rounded-full text-xs">
                Swap my token to USDC <ArrowUpRight className="w-3" />
              </div>
